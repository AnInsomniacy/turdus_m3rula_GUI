...
# config.py - Configuration and constants for Turdus Merula GUI
...
# Tool paths
TURDUSRA1N_PATH = "./turdus_m3rula/bin/turdusra1n"
TURDUS_MERULA_PATH = "./turdus_m3rula/bin/turdus_merula"
